  ...
  return (
    <>
      <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 dark:bg-slate-900 dark:text-white
          ${
            sticky?"sticky-navbar shadow-md bg-base-200 duration-300 transition-all ease-in-out dark:dark:bg-slate-600 dark:text-white": ""
        ...
        <div className="navbar">
          ...
          <div className="navbar-end space-x-3">
            ...
            <div className='hidden md:block'>
              <label className="flex items-center border border-gray-300 px-2 py-2 rounded-md">
                <input type="search" 
